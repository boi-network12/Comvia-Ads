// components/AdsLanding/Footer.tsx
"use client";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-200/50 dark:border-gray-800/50 pt-8 flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">Comvia Ads</span>
            <span className="text-sm text-gray-400">© 2026</span>
          </div>

          <div className="flex items-center gap-6">
            <Link href="#" aria-label="Twitter" className="text-gray-400 hover:text-foreground transition-all hover:scale-110 transform">
              <FaTwitter className="w-5 h-5" />
            </Link>
            <Link href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-foreground transition-all hover:scale-110 transform">
              <FaLinkedin className="w-5 h-5" />
            </Link>
            <Link href="#" aria-label="GitHub" className="text-gray-400 hover:text-foreground transition-all hover:scale-110 transform">
              <FaGithub className="w-5 h-5" />
            </Link>
            <Link href="#" aria-label="Email" className="text-gray-400 hover:text-foreground transition-all hover:scale-110 transform">
